...
export const fetchUserData = createAsyncThunk('fetch/fetchUserData', async (params: { fullName: string }) => {
...
export const fetchRegister = createAsyncThunk('fetch/fetchRegister', async (params: { fullName: string }) => {
